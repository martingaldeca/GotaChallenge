# Generated by Django 3.2.12 on 2022-03-28 19:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='ingredients',
            field=models.ManyToManyField(help_text='All the needed ingredients in the recipy step', related_name='recipy_steps', through='core.StepIngredientRelationShip', to='core.Ingredient', verbose_name='Ingredients'),
        ),
        migrations.CreateModel(
            name='Recipy',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Allowed actions for the device. The actions can be active or not, you can check that info looking the through model.', related_name='devices_allowed', through='core.DeviceActionRelationship', to='core.Action', verbose_name='Allowed actions'),
        ),
    ]
